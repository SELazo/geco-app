...
export const GEditGroupFormStep1Page = () => {
  const { id } = useParams();
  ...
  const onSubmit = async (data: IEditGroupForm) => {
    try {
      ...
      // Navegar al paso 2 (gestión de miembros actuales) con mensaje de éxito
      navigate(`/contacts/groups/edit-group/${id}/members`, {
        state: { message: 'Información básica actualizada correctamente' }
      });
  ...
  return (
    <div className="geco-add-group-main">
      ...
      <div className="geco-add-group-header-title">
        <GHeadSectionTitle
          title="Editar grupo"
          subtitle="Modifica la información básica del grupo. 📝 \n Actualiza el nombre y descripción para mantenerlo organizado. 📋"
        />
      </div>
